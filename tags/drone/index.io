...
<head>
  ...
  <link rel="shortcut icon" href="https://pradippatil.github.io/img/favicon.png" type="image/x-icon" />

  
    <link rel="stylesheet" href="https://pradippatil.github.io/css/my.css">
  
  
    <script src="https://pradippatil.github.io/js/my.js"></script>
...
<div id="menu">
  ...
  <a class="pure-menu-heading brand" href="https://pradippatil.github.io/">
  <img src="https://pradippatil.github.io/img/logo.png" width="100px">
</a>
  ...
  <div class="pure-menu">
    <ul class="pure-menu-list">
        ...
        <li class="pure-menu-item">
          <a class="pure-menu-link" href="https://pradippatil.github.io/post/"><i class='fa fa-list' aria-hidden='true'></i> Posts</a>
      
        </li>
      
      
        <li class="pure-menu-item">
          <a class="pure-menu-link" href="https://pradippatil.github.io/projects/"><i class='fa fa-folder-o' aria-hidden='true'></i> Projects</a>
      
        </li>
      
      
        <li class="pure-menu-item">
          <a class="pure-menu-link" href="http://stackoverflow.com/story/pradippatil"><i class='fa fa-user'></i> About</a>
  ...
  <ul class="pure-menu-list">
    ...
    <li class="pure-menu-item">
      <a class="pure-menu-link" href="https://linkedin.com/in/pradip86" target="_blank"><i class="fa fa-linkedin-square fa-fw"></i>LinkedIn</a>
    </li>
    ...
    <li class="pure-menu-item">
      <a class="pure-menu-link" href="https://www.goodreads.com/pradipatil" target="_blank">
      <span class="icon-stack">
    <i class="icon-sign-blank icon-stack-base"></i>
    <i class="icon-light"><span style="font-family:helvetica;font-size:18px">g</span></i> </span>
      Goodreads
      </a>
    </li>
...
<div class="content">
    ...
    <article>
  <header>
    <h2><a href="https://pradippatil.github.io/post/how-to-hugo/">Build a version controlled blog using Hugo, GitHub and Drone.io</a></h2>
  ...
  <div>
    <i class="fa fa-tags fa-fw"></i>
      ...
      <a class="post-taxonomy-tag" href="https://pradippatil.github.io/tags/hugo">hugo</a>&nbsp;&#47;
    
      <a class="post-taxonomy-tag" href="https://pradippatil.github.io/tags/githubpages">githubpages</a>&nbsp;&#47;
    
      <a class="post-taxonomy-tag" href="https://pradippatil.github.io/tags/drone.io">drone.io</a>
...
1. Build a static blog locally Static web pages are delivered to user exactly as stored unlike dynamic web pages which include web server processing for every request, for example, getting data from database, embedding it in configured templates and generating a HTML page to deliver to user.
  ...
  <footer>
    <a href="https://pradippatil.github.io/post/how-to-hugo/">Read more<i class="fa fa-angle-double-right fa-fw"></i></a>
  </footer>
...
<script src="https://pradippatil.github.io/js/ui.js"></script>
